            ...
            <div class="mt-12 flex flex-col items-center">
                ...
                <div class="w-full  flex-1 mt-8">
                    ...
                    <form action="{{route('login.store')}}" method="post" class="mx-auto max-w-xs">
                        ...
                        <p class="flex flex-col items-center justify-center mt-10 text-center text-md text-gray-500">
                            <span></span>
                            <a href="{{ route('password.request') }}" class="text-indigo-500 hover:text-indigo-500no-underline hover:underline cursor-pointer transition ease-in duration-300">¿Olvidaste la Contraseña?</a>
                        </p>
                    </form>
                </div>
            </div>

    ...
    <div class="flex items-center justify-between p-2 border-b dark:border-blue-800">
      ...
      <nav aria-label="Secondary" class="hidden space-x-2 md:flex md:items-center">
        ...
        <button
          ...
          <span class="absolute -top-2 left-6 rounded-full bg-red-500 p-0.5 px-2 text-sm text-red-50">1</span>
        ...
        <div class="relative" x-data="{ open: false }">
          ...
          >
            ...
            <svg aria-hidden="true" role="img"  width="32" height="32" preserveAspectRatio="xMidYMid meet" viewBox="0 0 256 256"><path fill="currentColor" d="M172 120a44 44 0 1 1-44-44a44 44 0 0 1 44 44Zm60 8A104 104 0 1 1 128 24a104.2 104.2 0 0 1 104 104Zm-16 0a88 88 0 1 0-153.8 58.4a81.3 81.3 0 0 1 24.5-23a59.7 59.7 0 0 0 82.6 0a81.3 81.3 0 0 1 24.5 23A87.6 87.6 0 0 0 216 128Z"></path></svg>
          ...
          <div
            ...
            class="absolute right-0 w-48 z-50 py-1 bg-white rounded-md shadow-lg top-12 ring-1 ring-black ring-opacity-5 dark:bg-dark focus:outline-none"
            tabindex="-1"
            role="menu"

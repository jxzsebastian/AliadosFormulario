                            ...
                            <div class=" inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                                <div class="max-h-full	border-gray-300 dark:border-gray-700 md:rounded-lg">
                                    <table
                                        ...
                                        <tbody
                                            class="bg-white divide-y divide-gray-300 dark:divide-gray-700 dark:bg-gray-900">
                                                    ...
                                                    <tr>
                                                        <td class="px-4 py-4 text-sm font-medium whitespace-nowrap">
                                                            <a href="{{route('lista.show', $emprendedor->id)}}">
                                                                ...
                                                                <span
                                                                    ...
                                                                    <p class="mx-2">{{ $emprendedor->correo_emprendedor }}
                                                                    </p>
                                                                </span>
                                                        ...
                                                        <td class="px-4 py-4 text-sm whitespace-nowrap">
                                                            <div>
                                                                ...
                                                                <p class="text-sm text-sm text-gray-600 mt-2">
                                                                    Programa SENA Actual: <strong class="">{{$estado->programa_sena_actual}}</strong>
                                                            ...
                                                            <div class="flow-root">
                                                                <ul class="m-6 listitems">
                                                                    ...
                                                                    @foreach ($remision->historialSeguimiento as $key => $segumiento)
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <div class="min-w-0 flex-1">
                                                                                        <div>
                                                                                            <div class="text-sm">
                                                                                                <a href="#"
                                                                                                    class="font-medium text-gray-900 dark:text-gray-200">{{ $segumiento->usuario->name }}</a>
                                                                                            </div>

                                                                                            <p
                                                                                                class="mt-0.5 text-sm text-gray-500 dark:text-gray-400">
                                                                                                Actualizo la Remision el:
                                                                                                <strong> {{ \Carbon\Carbon::parse($segumiento->created_at )->isoFormat('MMMM Do YYYY, h:mm a') }}</strong>
                                                                                            </p>
                                                                                        </div>
                                                                                        <div
                                                                                ...
                                                                                <div class="relative pb-8">
                                                                                    ...
                                                                                    <div class="relative flex space-x-3">
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <div>
                                                                                                <div class="text-sm">
                                                                                                        <p class="text-sm text-gray-500"> Estado Cambiado A: <a href="#" class="font-medium text-gray-900 dark:text-gray-400">{{$remision->historialSeguimiento[$key + 1]->estado  }}</a>
                                                                                                        <p class="text-sm text-gray-500"> Autor del Cambio: <a href="#" class="font-medium text-gray-900 dark:text-gray-400">{{ $remision->historialSeguimiento[$key + 1]->first()->usuario->name }}</a>
                                                                                            </p>
                                                                                                </div>

                                                                                                <p
                                                                                                    class="mt-0.5 text-sm text-gray-500 dark:text-gray-400">
                                                                                                    Actualización de la Remision:
                                                                                                    <time datetime="{{ \Carbon\Carbon::parse($remision->historialSeguimiento[$key + 1]->latest('created_at')->first()->created_at)->isoFormat('MMMM Do YYYY, h:mm a') }}">
                                                                        ...
                                                                        @endif
                                                                        @if ( $key + 1 < count($remision->historialSeguimiento) && $remision->historialSeguimiento[$key + 1]->programa_sena_actual !== $segumiento->programa_sena_actual)
                                                                        <li class="item">
                                                                            <div class="relative pb-8">
                                                                                <span
                                                                                class="absolute top-5 left-5 -ml-px h-full w-0.5 dark:bg-slate-700 bg-gray-200"
                                                                                ...
                                                                                <div class="relative flex space-x-3">
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <div>
                                                                                            <div class="text-sm">
                                                                                                    <p class="text-sm text-gray-500"> Programa Sena Cambiado A: <a href="#" class="font-medium text-gray-900 dark:text-gray-400">{{$remision->historialSeguimiento[$key + 1]->programa_sena_actual  }}</a>
                                                                                                    <p class="text-sm text-gray-500"> Autor del Cambio: <a href="#" class="font-medium text-gray-900 dark:text-gray-400">{{ $remision->historialSeguimiento[$key + 1]->first()->usuario->name }}</a>
                                                                                        </p>
                                                                                            </div>
